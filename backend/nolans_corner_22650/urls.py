"""nolans_corner_22650 URL Configuration
...
admin.site.site_header = "the treasure box"
admin.site.site_title = "the treasure box Admin Portal"
admin.site.index_title = "the treasure box Admin"

# swagger
api_info = openapi.Info(
    title="Nolans Corner API",
    default_version="v1",
    description="API documentation for Nolans Corner App",
)
